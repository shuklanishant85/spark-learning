...
public class StructuredStreamingUtility {
	...
	public static StructType userSchema() {
		return new StructType(
				new StructField[] { new StructField("name", DataTypes.StringType, false, Metadata.empty()),
						new StructField("pcode", DataTypes.LongType, true, Metadata.empty()),
	...
	public static StructType dataSchema() {
		return new StructType(
				new StructField[] { new StructField("time_stamp", DataTypes.StringType, false, Metadata.empty()),
						new StructField("data", DataTypes.IntegerType, false, Metadata.empty()), });
	}
